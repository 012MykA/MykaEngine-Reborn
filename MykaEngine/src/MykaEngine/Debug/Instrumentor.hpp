...
#define MYKA_PROFILE_FUNCTION() MYKA_PROFILE_SCOPE(__FUNCSIG__)
#else
#define MYKA_PROFILE_BEGIN_SESSION(name, filepath)
#define MYKA_PROFILE_END_SESSION()
#define MYKA_PROFILE_SCOPE(name)
#define MYKA_PROFILE_FUNCTION()
#endif